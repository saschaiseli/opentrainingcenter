...
public class ZoneHelper {
    ...
    public static Color getZonenFarbe(final Zone zone) {
        final String color = Activator.getDefault().getPreferenceStore().getString(zone.getName() + "_color");
    ...
    public static double getZonenWert(final IAthlete athlete, final Zone zone) {
        ...
        if (zonenWert <= 0) {
            logger.error("zonenwert ist null: " + zone.getName() + " Athlete " + athlete.toString());
            return 0;
        }
