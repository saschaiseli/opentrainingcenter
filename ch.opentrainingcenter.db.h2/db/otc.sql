...
(
	...
	ID_FK_ROUTE INTEGER,
	ID_FK_ATHLETE INTEGER,
	ID_FK_TRAININGPROPERTY INTEGER, 
	PRIMARY KEY (ID)
);
...
ALTER TABLE PUBLIC.TRAINING ADD FOREIGN KEY (ID_FK_ATHLETE) REFERENCES OTC.PUBLIC.ATHLETE (ID);
ALTER TABLE PUBLIC.TRAINING ADD FOREIGN KEY (ID_FK_TRAININGTYPE) REFERENCES OTC.PUBLIC.TRAININGTYPE (ID); 
ALTER TABLE PUBLIC.TRAINING ADD FOREIGN KEY (ID_FK_TRAININGPROPERTY) REFERENCES OTC.PUBLIC.TRACKTRAININGPROPERTY (ID); 
ALTER TABLE PUBLIC.TRACKTRAININGPROPERTY ADD FOREIGN KEY(ID_FK_STRECKENPUNKT) REFERENCES OTC.PUBLIC.STRECKENPUNKTE(ID);
ALTER TABLE PUBLIC.PLANUNGWOCHE ADD FOREIGN KEY (ID_FK_ATHLETE) REFERENCES OTC.PUBLIC.ATHLETE (ID);
ALTER TABLE PUBLIC.ROUTE ADD FOREIGN KEY (ID_FK_ATHLETE) REFERENCES OTC.PUBLIC.ATHLETE (ID);
