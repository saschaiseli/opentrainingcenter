...
public class DatabaseCreator extends Dao {
    ...
    private List<String> getQueries() {
        ...
        queries.add("CREATE TABLE PUBLIC.IMPORTED (ID INTEGER NOT NULL, ID_FK_ATHLETE INTEGER,IMPORTED_DATE TIMESTAMP, ACTIVITY_ID TIMESTAMP,COMMENTS VARCHAR(2147483647),ID_FK_WEATHER INTEGER, PRIMARY KEY (ID))");//$NON-NLS-1$
