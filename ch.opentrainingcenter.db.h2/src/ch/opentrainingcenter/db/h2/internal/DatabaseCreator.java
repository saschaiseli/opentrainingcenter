...
public class DatabaseCreator extends Dao {
    ...
    private List<String> getQueries() {
        ...
        queries.add("CREATE TABLE PUBLIC.PLANUNGWOCHE ( ID INTEGER NOT NULL, KW INTEGER, JAHR INTEGER,ACTIVE BOOLEAN,KMPROWOCHE INTEGER, ID_FK_ATHLETE INTEGER, PRIMARY KEY (ID))");//$NON-NLS-1$
