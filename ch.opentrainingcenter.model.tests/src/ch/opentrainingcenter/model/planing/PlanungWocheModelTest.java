...
public class PlanungWocheModelTest {
    ...
    private List<IPlanungModel> planungen;
    ...
    public void testPopulateNotEmpty() {
        ...
        planungen = new ArrayList<IPlanungModel>();
        final IPlanungModel eins = ModelFactory.createPlanungModel(athlete, jahr, 12, 42);
        final IPlanungModel zwei = ModelFactory.createPlanungModel(athlete, jahr, 13, 84);
        planungen.add(eins);
        planungen.add(zwei);
    ...
    public void testUpdateNotEmpty() {
        ...
        final IPlanungModel eins = ModelFactory.createPlanungModel(athlete, jahr, 12, 42);
        final IPlanungModel zwei = ModelFactory.createPlanungModel(athlete, jahr, 13, 84);
        final IPlanungModel drei = ModelFactory.createPlanungModel(athlete, jahr, 14, 1042);
        planungen.add(eins);
        planungen.add(zwei);
    ...
    private void assertPlanung(final PlanungWocheModel wochenModel, final int j, final int k, final int km) {
        final IPlanungModel planung = wochenModel.getPlanung(j, k);
