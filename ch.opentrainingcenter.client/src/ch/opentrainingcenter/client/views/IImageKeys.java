...
public final class IImageKeys {
    ...
    public static final String BACKUP = "icons/drive_backup_24_24.png";

    public static final String LOCK = "icons/stock_lock.png";

    public static final String LOCK_OPEN = "icons/stock_lock_open.png";
