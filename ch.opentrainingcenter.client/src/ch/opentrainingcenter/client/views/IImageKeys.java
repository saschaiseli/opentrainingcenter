...
public final class IImageKeys {
    ...
    public static final String IMPORT_GPS_KLEIN = "icons/16_16/import_wiz.gif"; //$NON-NLS-1$

    public static final String IMPORT_GPS_GROSS = "icons/16_16/import_wiz.gif"; //$NON-NLS-1$
    ...
    public static final String SEARCH_16 = "icons/16_16/search_16_16.png"; //$NON-NLS-1$

    public static final String SEARCH_72 = "icons/64_64/search_72_72.png"; //$NON-NLS-1$
    ...
    public static final String DATABASE = "icons/16_16/repository_rep.png"; //$NON-NLS-1$
}
