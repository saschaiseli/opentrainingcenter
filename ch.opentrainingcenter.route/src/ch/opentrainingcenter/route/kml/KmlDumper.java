...
public class KmlDumper {
    ...
    // * alle koordinaten
    // */
    // public void addLine(final String lineName, final String color, final
    // String coordinates) {
    // kmlFile.addKmlLine(lineName, color, coordinates);
    // }
    //
    // public void addPlacemark(final String name, final
    // List<SimplePair<String>> extendedData, final String coordinates) {
     ...
     */
    public void dump(final String kmlString) {
        if (kmlDumpPath != null) {
