...
public class RouteColumnLabelProviderBeschreibungTest {
    ...
    @Test
    public void test() {
        final RouteColumnLabelProviderBeschreibung provider = new RouteColumnLabelProviderBeschreibung();
        when(route.getBeschreibung()).thenReturn("junit");
